...
Tài liệu này mô tả mô hình domain cốt lõi của Phase 1 cho hệ thống Tutor.
...
**Vai trò:**
Student là Aggregate Root đại diện cho một học sinh trong hệ thống. Student sở hữu và bảo vệ trạng thái vòng đời học tập của học sinh.
...
**Vai trò:**
ChapterProgress là Aggregate Root đại diện cho tiến độ học tập của một Chapter đối với một Student. Đây là đơn vị tiến độ DUY NHẤT trong Phase 1.
...
**Vai trò:**
Practice là Entity phụ thuộc ChapterProgress. Practice tồn tại để ghi nhận việc luyện tập và làm trigger cho domain flow. Practice KHÔNG phải là Aggregate Root.
...
## 6. CONTENT DOMAIN (NON-LEARNING AGGREGATES)
...
### 6.5. Content Domain – Explicit Boundaries

**Content Domain entities KHÔNG được:**
