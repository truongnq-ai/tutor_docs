...
Backend trả lỗi phù hợp cho Student. Student có thể retry hành động Do Practice sau đó.
...
## 5. PRACTICE SUBMISSION FLOW (SUBMIT PRACTICE)
...
## 9. POSTCONDITIONS (TRẠNG THÁI SAU)
...
- → Tài liệu liên quan:
  - [Start Learning Flow](start-learning-flow.md)
