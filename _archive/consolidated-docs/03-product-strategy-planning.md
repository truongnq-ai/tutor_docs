...
================================================================================
# File: 03-for-product-owners/product-overview.md
================================================================================
...
- Học sinh đăng nhập/đăng ký: Google, Apple, Manual; sau OAuth bắt buộc đặt username/password; username manual alphanumeric (case-insensitive); chuẩn bị cho Phase 2 đa học sinh/thiết bị.
...
## 2.3. Roadmap phân kỳ (định hướng tính năng)

- **Phase 1 (MVP – hiện tại)**  
  - Môn: Toán lớp 6–7  
  - Student App: Onboarding, lộ trình hằng ngày, luyện tập cá nhân hoá, mini test, tutor mode (ảnh/text)  
  - Trial + paywall; liên kết phụ huynh 1:1 qua số điện thoại + OTP (Firebase Auth), auto-create parent nếu chưa có  
  - Parent Web: Đăng ký/đăng nhập (phone/password hoặc OAuth + verify phone), tổng quan, điểm yếu, báo cáo tuần cơ bản  
  - Notification: In-app / web (Firebase); chưa gửi email/Zalo  
  - Chưa có billing/payments

- **Phase 2 (mở rộng)**  
  - Quan hệ 1:N: một phụ huynh quản lý nhiều học sinh; parent có thể thêm nhiều StudentProfile; student-first linking auto-tạo hồ sơ mới  
  - Billing/Payments theo gói kiểu Office365:  
    - Personal: 1 học sinh  
    - Family: 3 học sinh  
    - Enterprise: N học sinh (liên hệ)  
  - Notification: vẫn chỉ in-app/web qua Firebase (chưa bật email/Zalo)  
  - Ưu tiên hoàn thiện thêm secondary screens nếu đủ nguồn lực; nâng cấp báo cáo chi tiết có thể lùi Phase 3

- **Phase 3 (mở rộng tiếp)**  
  - Notification Service: email/Zalo  
  - Báo cáo phụ huynh nâng cao (progress chi tiết, export, báo cáo theo kỳ)  
  - Admin/Ops dashboard nâng cao (quản trị nội dung, giám sát chất lượng)  
  - Mở rộng lớp: Toán 8–9 (môn khác sẽ sau Phase 3)
...
================================================================================
# End of: 03-for-product-owners/product-overview.md
================================================================================

================================================================================
# File: 03-for-product-owners/kpis-metrics.md
================================================================================
...
================================================================================
# End of: 03-for-product-owners/kpis-metrics.md
================================================================================

================================================================================
# File: 03-for-product-owners/roadmap.md
================================================================================
...
================================================================================
# End of: 03-for-product-owners/roadmap.md
================================================================================
