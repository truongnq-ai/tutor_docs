# Prompt Template cho Tạo Bài Tập Toán Lớp 6
...
Nhiệm vụ của bạn là:
- Tạo bài tập Toán phù hợp với chương trình Toán lớp 6 Việt Nam
...
```
Hãy tạo {COUNT} bài tập Toán cho học sinh lớp 6 với các yêu cầu sau:
