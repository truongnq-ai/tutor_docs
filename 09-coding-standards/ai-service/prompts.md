# AI PROMPTS - CODING STANDARDS

← Quay lại: [README.md](../README.md)

## Tổng quan

Tài liệu này tập hợp các prompt mẫu chuẩn dùng cho hệ thống Tutor AI - Gia sư Toán cá nhân hoá.
...
## SYSTEM PROMPT – Giáo viên Toán Việt Nam (BẮT BUỘC)
...
## USER PROMPT – Giải bài Toán theo chương trình
...
## OUTPUT FORMAT PROMPT – Ép định dạng lời giải
...
## PROMPT – Chế độ học (Anti-copy / Tutor Mode)
...
## PROMPT – Phát hiện điểm yếu học sinh (Skill Diagnosis)
...
## PROMPT – Sinh bài luyện tập tương tự
...
## PROMPT – Mini Test đánh giá Chapter
...
## PROMPT – Nhận xét cho phụ huynh (Non-technical)
...
- [AI Integration](./ai-integration.md) - Core ↔ AI contract
- [Domain Model - Skill](../../02-domain-model/skill.md) - Skill Graph
